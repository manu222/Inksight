...
public class Persona implements Serializable {
    ...
    public Persona(String userName,String correo,String pass ,String first_name, String last_name, String location, boolean online, int followers,Stats stats) {
   ...
   /* public boolean passMatch(String s){
        return pass.equals(DB.bytesToHex);
    }
*/
}
